...
4. Running the executable will automatically create an input file with the specified input format with random alphabet values ranging from 1 to 50, and two random strings of the specified lengths containing only the letters in the alphabet. This file is created in the io folder: io/input.txt
